---
description: "Use when editing Go code, dependency files, or build workflow in this repository. Enforces local validation, dependency hygiene, and contribution safety checks for srlmgr/cli."
name: "Go Contribution Workflow"
